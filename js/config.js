...
(function () {
  ...
  G.WEAPONS = [
    ...
    { slot: 2, id: 'pistol',   name: 'PISTOL',       dmg: 25,  rpm: 240,  range: 60,  spread: 1.5, mag: 17, ammo: '9mm',    auto: false, price: 200,  clipPrice: 20,  sfx: 'pistol' },
    { slot: 3, id: 'deagle',   name: 'DESERT EAGLE', dmg: 70,  rpm: 90,   range: 70,  spread: 2,   mag: 7,  ammo: '.50',    auto: false, price: 1200, clipPrice: 60,  sfx: 'deagle' },
    { slot: 4, id: 'uzi',      name: 'MICRO-UZI',    dmg: 14,  rpm: 900,  range: 45,  spread: 5,   mag: 30, ammo: '9mm',    auto: true,  price: 800,  clipPrice: 20,  sfx: 'uzi' },
    { slot: 5, id: 'shotgun',  name: 'SHOTGUN',      dmg: 12,  rpm: 60,   range: 25,  spread: 8,   mag: 6,  ammo: 'shells', auto: false, pellets: 8, price: 900,  clipPrice: 40,  sfx: 'shotgun' },
    { slot: 6, id: 'ak',       name: 'AK-47',        dmg: 30,  rpm: 480,  range: 80,  spread: 3,   mag: 30, ammo: 'rifle',  auto: true,  price: 1500, clipPrice: 50,  sfx: 'ak' },
    { slot: 7, id: 'sniper',   name: 'SNIPER RIFLE', dmg: 120, rpm: 40,   range: 200, spread: 0,   mag: 5,  ammo: 'rifle',  auto: false, scope: true, price: 2500, clipPrice: 80,  sfx: 'sniper' },
    { slot: 8, id: 'rpg',      name: 'RPG',          dmg: 120, rpm: 30,   range: 100, spread: 0,   mag: 1,  ammo: 'rockets',auto: false, projectile: true, price: 4000, clipPrice: 500, sfx: 'rpgwhoosh' },
    { slot: 9, id: 'minigun',  name: 'MINIGUN',      dmg: 20,  rpm: 1800, range: 60,  spread: 4,   mag: 100,ammo: '5.56',   auto: true,  spinup: 0.7, price: 8000, clipPrice: 300, sfx: 'minigun' },
  ];
  G.weaponById = {};
